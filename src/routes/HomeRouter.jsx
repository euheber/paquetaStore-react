...
function Home(){ 
    ...
    return(
        ...
        <div className="max-w-6xl m-auto">
            <div className="w-40 md:mr-5 lg:w-[350px] ml-auto lg:mr-0">
                ...
                <div className="price">
                    <span className="font-medium text-shadeblack text-xs">A partir de</span>
    ...
    <div className=" bg-orange p-4">
        <ul className="m-auto max-w-5xl grid grid-cols-2 gap-4 lg:grid-cols-5 lg:grid-rows-1 lg:gap-2">
            <li className="flex gap-3 items-center">
                ...
                <div>
                    <span className="font-normal text-white text-xs">Pague em até 10x</span>
            ...
            <li className="flex gap-3 items-center">
                ...
                <div>
                    <span className="font-normal text-white text-xs">Retire grátis</span>
            ...
            <li className="flex gap-3 items-center">
                ...
                <div>
                    <span className="font-normal text-white text-xs">Ganhe 20% de</span>
            ...
            <li className="flex gap-3 items-center">
                ...
                <div>
                    <span className="font-normal text-white text-xs">Frente grátis para</span>
                    <p className="font-bold text-white text-xs">regiões sul e sudeste</p>
                </div>
            </li>
            ...
            <li className="flex gap-3 items-center">
                ...
                <div>
                    <span className="font-normal text-white text-xs">Primeira troca grátis</span>
    ...
    <div className="shoes mt-10">
            <div className="flex flex-col gap-2 justify-center items-center lg:flex-row">
                <ImageSlot sex="Calçados femininos" position="left-10" filter="bg-gradient-to-r">
                ...
                <div className="max-w-[500px] md:text-center lg:text-right lg:mb-20">
                    <p className="text-sm lg:text-lg font-montserrat">Escolher o seu sapato favorito entre nossa
                         <span className="font-bold"> variedade de modelos e cores</span> não será uma tarefa
            ...
            <div className="flex flex-col gap-2 justify-center items-center lg:flex-row lg:mt-10">
                <ImageSlot sex="Calçados masculino" position="right-10" filter="bg-gradient-to-l" order="lg:order-2">
                <img src="/images/calcados-masculinos.png" alt="Calçado Feminino" />
                </ImageSlot>
        ...
        <div className="outlet mt-10">
            <div className="flex gap-4 justify-center items-center lg:justify-between">
                <div className="logo w-36 flex flex-col">
                    ...
                    <span className="text-3xl text-orange font-bold uppercase self-end">Outlet</span>
                </div>
        ...
        <section className="mt-10">
            <div className="header flex justify-between items-center">
               ...
               <a href="" className="text-md border-b-orange border-b">
                    ...
                    <span className="hover:scale-95 block transition-all duration-100">Conferir tudo</span>
               </a>
